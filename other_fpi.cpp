...
int main(int argc, char** argv) {
    ...
    printf("deriv: %.12g   %.12g\n", deriv[Njack - 1], myres->comp_error(deriv));
    std::string name_jack_fpi = "deriv/deriv_val_fpi_P5A0_" + std::string(argv[3]) +  "_" + myres->option +std::to_string(Njack-1)+".dat";
    ...
    name_jack_fpi = "deriv/deriv_val_fpi_WTI_" + std::string(argv[3]) +  "_" + myres->option  + std::to_string(Njack-1) + ".dat";

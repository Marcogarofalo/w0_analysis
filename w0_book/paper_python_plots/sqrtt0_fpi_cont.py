...
def plot_fit(ax, basename, var, data_type=None, noribbon=False,
    ...
    colorlist = [purple, maroon, blue]
    colorlist1 = [ purple, maroon, blue]
...
basenames = [
    f"fit_sqrtt0_fpiwp25_a2",
    f"fit_sqrtt0_fpiwp25_a2_noB",
    f"fit_sqrtt0_fpiwp25_a2_noC",
    f"fit_sqrtt0_fpiwp25_a2_noD",
    f"fit_sqrtt0_fpiwp25_a2_noE",
    f"fit_sqrtt0_fpiwp25_a2_a4",
    f"fit_sqrtt0_fpiwp25_a2_Husung0.42"
]
flat_boot = [] 
...
print("BAIC ",[BAIC_ave],"  ",[BAIC_err] )
ax[1].errorbar([0.0001],[BAIC_ave],[BAIC_err],fmt="x",color="black",label=f"BAIC average")
ax[1].errorbar([0.0001],[BAIC_ave],[stat_err],fmt="",color="black")
#ax[1].set_ylim(0.167, 0.176)
# histogram
# Nota per Marco: in flat_boot c'è sostanzialmente un array che contiene un ricampionamento bootstrap
# dei limiti al continuo. flat_weig sono i pesi normalizzati con la somma dei pesi (e li moltiplico

...
def plot_fit(ax, basename, var, data_type=None, noribbon=False,
    ...
    marker_choices = ['v','o','^', 'v',  'D', 's', '<', '>', 'p', '*']
    colorlist = [blue, orange, red]
    
    colorlist1 = [ orange, red, blue]
    ...
    if (not noribbon) or (not noline):
        for idx, n in enumerate(Nfits):
            ...
            if not noline:
                ...
                ax.plot(x_vals, y_vals,color=colorlist1[idx],alpha=0.5,linestyle="dashed",linewidth=0.4)
...
basenames = [
    f"fit_fpi_C{C}.000000_N3_a2",
    f"fit_fpi_C{C}.000000_N3_a2_noBOS_noBtm_noBWTI",
    f"fit_fpi_C{C}.000000_N3_a2_noCOS_noCtm_noCWTI",
    f"fit_fpi_C{C}.000000_N3_a2_a4WTI",
    f"fit_fpi_C{C}.000000_N3_a2_a4tm",
    f"fit_fpi_C{C}.000000_N3_a2_a4OS",
    f"fit_fpi_C{C}.000000_N3_a2_a4_noa4WTI",
    f"fit_fpi_C{C}.000000_N3_a2_a4_noa4tm",
    f"fit_fpi_C{C}.000000_N3_a2_a4_noa4OS",
    f"fit_fpi_C{C}.000000_N3_a2_HusungWTI",
    f"fit_fpi_C{C}.000000_N3_a2_Husungtm",
    f"fit_fpi_C{C}.000000_N3_a2_HusungOS"
]
...
ax[0].hist(flat_boot, bins=10, weights=np.array(flat_weig)*100/Nboot,orientation="horizontal",histtype='step', linewidth=1.5,color="black")

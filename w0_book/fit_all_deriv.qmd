...
gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
                      alpha=0.3)
fig <- myplotly(gg, "", "$(\\mu/\\mu_\\ell)$", "$(\\mu_\\ell/f_\\pi) df_\\pi/d\\mu$",
  to_print = TRUE,
  yrange = c(-0.005, 0.02),
...
gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
                      alpha=0.3)
fig <- myplotly(gg, "", "$(\\mu/\\mu_\\ell)$", "$(\\mu_\\ell /M_\\pi) dM_\\pi/d\\mu$",
  to_print = TRUE,
  yrange = c(-1, 4),
  legend_position = c(0.7, 0.98)
)
...
gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
                      alpha=0.3)
fig <- myplotly(gg, "", "$(\\mu/\\mu_\\ell)$", "$(\\mu_\\ell )d(M_\\pi/f_\\pi)/d\\mu$",
  to_print = TRUE,
  #yrange = c(-1, 4),
  legend_position = c(0.7, 0.98)
)

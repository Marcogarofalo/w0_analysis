...
gg <- NULL
basenames <- c(
  "/home/garofalo/analysis/flow/data/fit_all_beta/der_charm_a2",
  "/home/garofalo/analysis/flow/data/fit_all_beta/der_charm_a2_5pt"
)
labels <- c(
  "P[0] + P[1]*a2 ",
  "5pt =P[0] + P[1]*a2 "
...
# gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
#                       alpha=0.3)
fig <- myplotly(gg, "", "$a^2$", "$(\\mu_\\ell/ w_0)  dw_0/d\\mu$",
  to_print = TRUE,
  #yrange = c(-1, 4),
...
gg <- NULL
basenames <- c(
  "/home/garofalo/analysis/flow/data/fit_all_beta/der_sqrtt0_full_mu_mu2_mu3"
)
labels <- c(
  "P[0]/amu + P[1]/amu2 + P[3]/amu3 "
)
...
gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
                      alpha=0.3)
fig <- myplotly(gg, "", "$(\\mu/\\mu_\\ell)$", "$(\\mu_\\ell/ \\sqrt{t_0})  d\\sqrt{t_0}/d\\mu$",
  to_print = TRUE,
  #yrange = c(-1, 4),
  legend_position = c(0.7, 0.98)
)
...
gg <- NULL
basenames <- c(
  "/home/garofalo/analysis/flow/data/fit_all_beta/der_sqrtt0_charm_a2",
  "/home/garofalo/analysis/flow/data/fit_all_beta/der_sqrtt0_charm_a2_5pt"
)
labels <- c(
  "7pt",
  "5pt =P[0] + P[1]*a2 "
...
# gg <- gg + geom_vline(xintercept = masses[3] / masses[1], linetype = "dashed",
#                       alpha=0.3)
fig <- myplotly(gg, "", "$a^2$", "$(\\mu_\\ell/ \\sqrt{t_0})  d\\sqrt{t_0}/d\\mu$",
  to_print = TRUE,
  #yrange = c(-1, 4),
  legend_position = c(0.1, 0.1)
)

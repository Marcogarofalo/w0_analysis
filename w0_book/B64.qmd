...
df <- NULL
df <- add_corr_to_df("W(t)", all_obs, mt, df, print_res = FALSE, reshape = FALSE)
df <- add_corr_to_df("W+mul_correction(t)", all_obs, mt, df, print_res = FALSE, reshape = FALSE)
df <- add_corr_to_df("W+mus_correction(t)", all_obs, mt, df, print_res = FALSE, reshape = FALSE)
df <- add_corr_to_df("W+muc_correction(t)", all_obs, mt, df, print_res = FALSE, reshape = FALSE)
...
# all_obs <- Rose::get_all_corr(mt)
# df <- add_corr_to_df("W_rewcOS(t)", all_obs, mt, df, print_res = FALSE, nudge = 0.2, reshape = FALSE,rename="W_rewcOS(t)_half_stat")

...
double lhs_fun(int n, int e, int j, data_all gjack, struct fit_type fit_info) {
    ...
    // r *= gjack.en[e].jack[fit_info.corr_id[2]][j];       // muliso
    return r;
}
...
int main(int argc, char** argv) {
    ...
    std::vector<double> x_phys_point = { Mpi_MeV / fpi_MeV }; // Mpi/fpi
    ...
    for (int i = 0; i < der_name.size(); i++) {
        ...
        print_fit_band(argv, jackall, fit_info, fit_info, namefit.c_str(), "Mpi_over_fpi", der_fpi_const_full, der_fpi_const_full, 0, fit_info.Nxen[0][0] /* set the other variables to the first of the n*/, dx, {});
    ...
    for (int i = 0; i < der_name.size(); i++) {
        ...
        print_fit_band(argv, jackall, fit_info, fit_info, namefit.c_str(), "Mpi_over_fpi", der_fpi_const_full_poly, der_fpi_const_full_poly, 0, fit_info.Nxen[0][0] /* set the other variables to the first of the n*/, dx, {});

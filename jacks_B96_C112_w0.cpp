...
int main() {
  ...
  for (int Nj : {20, 25, 30, 35, 40, 45}) {
    ...
    double *w0B96 = myres->create_fake(2.1288775, 0.0007680, 67);
    double *t0B96 = myres->create_fake(1.8035479, 0.0004070, -1);
    ...
    double *w0C112 = myres->create_fake(2.5099262, 0.0016857, -1);
    double *t0C112 = myres->create_fake(2.1112191, 0.0009974, -1);
